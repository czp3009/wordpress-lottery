...
lottery_button.each(function (index, val) {
    listener(jQuery(val));
});

function listener(lottery_button) {
    var user_count_input = lottery_button.siblings("input[name='user_count']");
    var canvas_div = lottery_button.siblings(".canvas");
